	...
	<div class="pusher">
		<div class="ui stackable page grid">
			<div class="row" align="center">
				<div class="column">
					<label class="ui header">Manage Users</label>
					<br>
				</div>
			</div>			
					...
					<table class="ui table">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<?php echo htmlentities($row['email'])." / ".htmlentities($row['contactno']);?>
								</td>
								<td>
									<?php echo htmlentities($row['shippingAddress'])."<br>".htmlentities($row['shippingCity'])."<br>".htmlentities($row['shippingState'])."<br>".htmlentities($row['shippingPincode']);?>
								</td>
								<td>
									<a class="ui primary icon button" href="deleteuser.php?uid=<?php echo htmlentities($row['id']);?>">
